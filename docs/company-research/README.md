...
| Follow-up search sequence | [follow-up-search-sequence.svg](assets/follow-up-search-sequence.svg) | [follow-up-search-sequence.mmd](diagrams/follow-up-search-sequence.mmd) |
| Search subgraph internals | [search-subgraph.svg](assets/search-subgraph.svg) | [search-subgraph.mmd](diagrams/search-subgraph.mmd) |
| State map | [state-map.svg](assets/state-map.svg) | [state-map.mmd](diagrams/state-map.mmd) |
| Interrupt and streaming flow | [interrupt-streaming.svg](assets/interrupt-streaming.svg) | [interrupt-streaming.mmd](diagrams/interrupt-streaming.mmd) |
...
![Search subgraph internals](assets/search-subgraph.svg)
...
![Follow-up search sequence](assets/follow-up-search-sequence.svg)
...
![Interrupt and streaming flow](assets/interrupt-streaming.svg)
